      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-md text-white/80 max-w-2xl mx-auto mb-8">
            I&apos;m currently open to discussing new opportunities in IT Infrastructure, 
            Network Security projects, or system optimization. Let&apos;s build 
            a more secure and connected digital environment together.
          </p>
          <a
        ...
        <div className="text-center mt-12 pt-8 border-t border-white/10">
          <p className="text-white/60 text-sm">
            © {new Date().getFullYear()} Muhammad Firdaus Ilhamy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
